...
for i in [-10,-3,-2,-1,1,2,3,10]:
    ...
    updatefilename("material_0/LiHMu_3172.xml",
...
#    submit_to_batch("material_0/LiHMu_3172_res_lim"+str(llim_172 + i*0.0109)+".xml")
    submitUnfolding("material_0/LiHMu_3172_res_lim"+str(llim_172 + i*0.0109)+".xml")

    updatefilename("material_0/LiHMu_3200.xml",
...
#    submit_to_batch("material_0/LiHMu_3200_res_lim"+str(llim_200 + i*0.0109)+".xml")
    submitUnfolding("material_0/LiHMu_3200_res_lim"+str(llim_200 + i*0.0109)+".xml")

    
    updatefilename("material_0/LiHMu_3240.xml",
...
#    submit_to_batch("material_0/LiHMu_3240_res_lim"+str(llim_240 + i*0.0109)+".xml")
    submitUnfolding("material_0/LiHMu_3240_res_lim"+str(llim_240 + i*0.0109)+".xml")
