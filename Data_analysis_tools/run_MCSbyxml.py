...
for i in range(8):        
    updatefilename("LiHMu_3172.xml", "LiHMu_3172_R_"+str(i)+".xml", "LiHMu_3172_R_"+str(i)+".root")
    updatecutval("LiHMu_3172_R_"+str(i)+".xml", "LiHMu_3172_R_"+str(i)+".xml", "fid_rad", 100 + i*10)
    submitUnfolding("LiHMu_3172_R_"+str(i)+".xml")
        
    updatefilename("LiHMu_3200.xml", "LiHMu_3200_R_"+str(i)+".xml", "LiHMu_3200_R_"+str(i)+".root")
    updatecutval("LiHMu_3200_R_"+str(i)+".xml", "LiHMu_3200_R_"+str(i)+".xml", "fid_rad", 100 + i*10)
    submitUnfolding("LiHMu_3200_R_"+str(i)+".xml")
             
    updatefilename("LiHMu_3240.xml", "LiHMu_3240_R_"+str(i)+".xml", "LiHMu_3240_R_"+str(i)+".root")
    updatecutval("LiHMu_3240_R_"+str(i)+".xml", "LiHMu_3240_R_"+str(i)+".xml", "fid_rad", 100 + i*10)
    submitUnfolding("LiHMu_3240_R_"+str(i)+".xml")
''' 
