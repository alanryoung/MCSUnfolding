...
//    pStart_vec_y(TVectorD(19)), theta_true_x(TVectorD(19)), theta_true_y(TVectorD(19))
{
  ...
  pass_Fid = new TH1D("pass_Fid",";Passed Cut; Events",100, 0, 200);
  pass_ExtTKU0 = new TH1D("pass_ExtTKU0",";Passed Cut; Events",3, 0, 3);
  pass_TOF01 = new TH1D("pass_TOF01",";Passed Cut; Events",100, 0, 40);
  pass_TOF01Ex = new TH1D("pass_TOF01Ex",";Passed Cut; Events",100, 0, 40);
  pass_mom = new TH1D("pass_mom",";Passed Cut; Events",100, 100, 300);
  ...
  mcpass_Fid = new TH1D("pass_Fid",";Passed Cut; Events",100, 0, 200);
  mcpass_ExtTKU0 = new TH1D("pass_ExtTKU0",";Passed Cut; Events",3, 0, 3);
  mcpass_TOF01 = new TH1D("pass_TOF01",";Passed Cut; Events",100, 0, 40);
  mcpass_TOF01Ex = new TH1D("pass_TOF01Ex",";Passed Cut; Events",100, 0, 40);
  mcpass_mom = new TH1D("pass_mom",";Passed Cut; Events",100, 100, 300);
