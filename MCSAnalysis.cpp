...
//    pStart_vec_y(TVectorD(19)), theta_true_x(TVectorD(19)), theta_true_y(TVectorD(19))
{
  ...
  mccuts_accept = new TH1D("mccuts_accept", 
			   ";Selection Criteria; Surviving Events", 14, 0, 14);
  pass_Tof1 = new TH1D("pass_TOF1",";Passed Cut; Events",3, 0, 3);
  pass_Tof0 = new TH1D("pass_TOF0",";Passed Cut; Events",3, 0, 3);
  pass_TKU = new TH1D("pass_TKU",";Passed Cut; Events",3, 0, 3);
  pass_TKUrad = new TH1D("pass_TKUrad",";Passed Cut; Events",100, 0, 200);
  pass_Diff = new TH1D("pass_Diff",";Passed Cut; Events",100, 0, 150);
  pass_Fid = new TH1D("pass_Fid",";Passed Cut; Events",3, 0, 3);
  pass_ExtTKU0 = new TH1D("pass_ExtTKU0",";Passed Cut; Events",3, 0, 3);
  pass_TOF01 = new TH1D("pass_TOF01",";Passed Cut; Events",3, 0, 3);
  pass_TOF01Ex = new TH1D("pass_TOF01Ex",";Passed Cut; Events",3, 0, 3);
  pass_mom = new TH1D("pass_mom",";Passed Cut; Events",3, 0, 3);
  pass_chi2= new TH1D("pass_chi2",";Chi2/dof; Events",50, 0, 10);

  mcpass_Tof1 = new TH1D("pass_TOF1",";Passed Cut; Events",3, 0, 3);
  mcpass_Tof0 = new TH1D("pass_TOF0",";Passed Cut; Events",3, 0, 3);
  mcpass_TKU = new TH1D("pass_TKU",";Passed Cut; Events",3, 0, 3);
  mcpass_TKUrad = new TH1D("pass_TKUrad",";Passed Cut; Events",100, 0, 200);
  mcpass_Diff = new TH1D("pass_Diff",";Passed Cut; Events",100, 0, 150);
  mcpass_Fid = new TH1D("pass_Fid",";Passed Cut; Events",3, 0, 3);
  mcpass_ExtTKU0 = new TH1D("pass_ExtTKU0",";Passed Cut; Events",3, 0, 3);
  mcpass_TOF01 = new TH1D("pass_TOF01",";Passed Cut; Events",3, 0, 3);
  mcpass_TOF01Ex = new TH1D("pass_TOF01Ex",";Passed Cut; Events",3, 0, 3);
  mcpass_mom = new TH1D("pass_mom",";Passed Cut; Events",3, 0, 3);
  mcpass_chi2= new TH1D("pass_chi2",";Chi2/dof; Events",50, 0, 10);
...
void MCSAnalysis::dataSelection2(){
  ...
  Collection USPostTOF01, DSPostTOF01, USPostTOF01Ex, DSPostTOF01Ex, USPostMom, DSPostMom;
  double pz = 0.;
  int Nevents = 0;
...
//------------------------------------------------------------------------------------------------------
    ...
    if ( sqrt(globalVars.USend_of_DStracker.X*globalVars.USend_of_DStracker.X + globalVars.USend_of_DStracker.Y*globalVars.USend_of_DStracker.Y) > meanp){
      std::cerr<<"**Failed Fiducial Cut"<<std::endl;
      pass_Fid->Fill("Fail",1);
      continue;
    } else {
...
//      std::cerr<<"TOF2 time: "<<rawTOF2HitTime<<std::endl;
    ...
    if ( rawTOF1HitTime - rawTOF0HitTime < TOF_lower_limit ||
	 rawTOF1HitTime - rawTOF0HitTime > TOF_upper_limit) {
      std::cerr<<"**Failed TOF01 Cut"<<std::endl;
      pass_TOF01->Fill("Fail",1);
      continue;
    }
...
//---------------------------------------------------------------------------------------
  ...
  if (momentum_absorber < momentum_lower_limit || momentum_absorber > momentum_upper_limit) {
    ...
    pass_mom->Fill("Fail",1);
    continue;
  }

//    std::cerr<<"Adding to AllTOF"<<std::endl;
//    display_Vars(globalVars.UScentre_absorber);
    USPostMom.append_instance(globalVars.UScentre_absorber);
//    std::cerr<<"Size of USAllTOF: "<<USAllTOF.N()<<std::endl;
//    display_Vars(globalVars.DScentre_absorber);
    DSPostMom.append_instance(globalVars.DScentre_absorber);
//    std::cerr<<"Size of DSAllTOF: "<<DSAllTOF.N()<<std::endl;
    cuts_accept->Fill("Momentum",1);
    pass_mom->Fill("Pass",1);
...
//------------------------------------------------------------------------------------------------------
  ...
  make_beam_histograms(USPostMom, "Upstream, Data Reference", "ref_10US_PostMom");
  make_beam_histograms(DSPostMom, "Downstream, Data Reference", "ref_10DS_PostMom");
